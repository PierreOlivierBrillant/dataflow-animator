...
export const demos: Demo[] = [
  ...
  },
  {
    ...
    description: {
      fr: 'Le serveur web renvoie du HTML puis du JavaScript ; la coquille rendue attend les données, que le Web API sert en JSON.',
      en: 'The web server returns HTML then JavaScript; the rendered shell waits for the data, which the Web API serves as JSON.',
    },
    category: 'web-api',
    tags: {
      fr: [
