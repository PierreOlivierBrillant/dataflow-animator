...
export const fr = {
  ...
  player: {
    ...
    exportVideo: "Exporter l'animation",
    exportFormat: 'Format',
    exportResolution: 'Résolution',
    exportFrameRate: 'Images/s',
    exportFps: '{n} i/s',
    exportEstimate: 'Environ {duration} · {size}',
    exportSeconds: '{n} s',
    exportMinutes: '{m} min {s} s',
    exportKilobytes: '{n} ko',
    exportMegabytes: '{n} Mo',
    startExport: 'Exporter',
    exporting: 'Export en cours…',
    finalisingExport: 'Finalisation…',
    ...
    describeStepCountOne: '{count} étape',
    ...
    describePause: 'Pause',
    describePacketHttp: 'un paquet HTTP',
    describePacketSqlRequest: 'une requête SQL',
    describePacketSqlResponse: 'une réponse SQL',
    describePacketRows: 'une réponse SQL de {rows} lignes',
    describePacketRowsOne: 'une réponse SQL de {rows} ligne',
